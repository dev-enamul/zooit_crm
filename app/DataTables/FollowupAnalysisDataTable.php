...
use App\Models\FollowupAnalysi;
...
class FollowupAnalysisDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action',function($followUp){
                return view('followup_analysis.followup_analysis_action',compact('followUp'))->render();
            })
     ...
     *
     * @param \App\Models\FollowupAnalysi $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FollowUpAnalysis $model, Request $request): QueryBuilder
    {
    ...
    {
        return 'FollowupAnalysis_' . date('YmdHis');
    }
}
