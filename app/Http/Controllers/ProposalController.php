...
use App\Services\AiProposalService;
...
class ProposalController extends Controller
{
    ...
    public function askAi(Request $request, AiProposalService $aiProposalService)
    {
        ...
        try {
            $updatedData = $aiProposalService->ask($proposalData, $prompt);
            return response()->json(['success' => true, 'message' => 'Proposal updated by AI.', 'data' => $updatedData]);
        } catch (\Exception $e) {
