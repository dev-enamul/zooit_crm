        ...
        <div class="container-fluid"> 
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card"> 
                        <div class="card-body">
                            <form action="{{route('designation.freelancer.update',$user->id)}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate> 
                                @csrf
                                <div class="row">  
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2" search name="designation_id" id="designation_id" required> 
                                                @foreach ($designations as $designation)
                                                    <option value="{{@$designation->id}}" {{@$user->freelancer->designation_id==$designation->id?"selected":""}}> {{$designation->title}} </option>
                                                @endforeach 
                                            </select> 
                                        </div>
                                    </div> 
