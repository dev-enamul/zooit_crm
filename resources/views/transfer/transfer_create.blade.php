...
@section('title','Project Transfer Entry')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Project Transfer Entry</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Project Transfer Entry</li>
                            </ol>
                        </div>
                    ...
                    <div class="card"> 
                        <div class="card-body">
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="deduction_type" value="Yes" id="deduction_type" disabled>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="transfer_fee" class="form-label">Sales Transfer Fee</label>
                                            <input class="form-control" type="number" name="transfer_fee" value="3564" id="transfer_fee" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="deduction_type" class="form-label">Transfer Type </label>
                                            <select id="deduction_type" class="select2" search name="deduction_type">
                                                <option value="">Same Project</option> 
                                                <option value="">Another Project</option> 
                                            </select> 
                                        </div>
                                ...
                                <h6 class="text-primary"> <i class="mdi mdi-check-all"></i>New Customer Information</h6>
                                <hr>
                                <div class="row">  
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="new_customer" class="form-label">New Customer <span class="text-danger">*</span></label>
                                            <select id="new_customer" class="select2" search name="new_customer">
                                                <option value="">Select Customer</option> 
                                                <option value="">Md Enamul Haque #8776</option> 
                                                <option value="">Jamil Hosain #8776</option> 
                                                <option value="">Md Mehedi Hasan #8776</option> 
                                                <option value="">Suvo Hasan #8776</option>  
                                            </select> 
                                        </div>
                                    </div>  
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="project_name" class="form-label">Project Name</label>
                                            <select id="project_name" class="select2" search name="project_name">
                                                <option value="">Din Tower</option> 
                                                <option value="">Musafir Tower</option>  
                                            </select> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="project_unit" class="form-label">Unit Name</label>
                                            <input class="form-control" type="text" name="project_unit" value="A12" id="new_project_name" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="unit_qty" value="12" id="unit_qty">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="unit_qty" class="form-label">Transfer Amount</label>
                                            <input class="form-control" type="number" name="unit_qty" value="2334" id="unit_qty">
                                        </div>
                                    </div> 
                                    
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="unit_qty" class="form-label">Declaration Value</label>
                                            <input class="form-control" type="number" name="unit_qty" value="2334" id="unit_qty">
                                        </div>
                                    </div> 
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="unit_qty" class="form-label">Sold Value</label>
                                            <input class="form-control" type="number" name="unit_qty" value="2334" id="unit_qty">
                                        </div>
                                    </div>
                                </div>
