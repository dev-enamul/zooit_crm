...
@if (in_array('division', $visible))
    <div class="{{ $div . ' ' . $mb }}">
        ...
        <select class="select2" search name="division" id="division" {{ in_array('division', $required) ? 'required' : '' }}>
...
@if (in_array('district', $visible))
    <div class="{{ $div . ' ' . $mb }}">
        ...
        <select class="select2 {{ $errors->has('district') ? 'is-invalid' : '' }}" search name="district" id="district" {{ in_array('district', $required) ? 'required' : '' }}>
...
@if (in_array('upazila', $visible))
    <div class="{{ $div . ' ' . $mb }}">
        ...
        <select class="select2" search name="upazila" id="upazila" {{ in_array('upazila', $required) ? 'required' : '' }}>
...
@if (in_array('union', $visible))
    <div class="{{ $div . ' ' . $mb }}">
        ...
        <select class="select2" search name="union" id="union" {{ in_array('union', $required) ? 'required' : '' }}>
...
@if (in_array('village', $visible))
    <div class="{{ $div . ' ' . $mb }}">
        ...
        <select class="select2" search name="village" id="village" {{ in_array('village', $required) ? 'required' : '' }}>
