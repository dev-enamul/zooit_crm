                                                    ...
                                                    <tr class="">
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prospecting_id[]" value="{{ $prospecting->id }}"
                                                                id="flexCheckChecked">
                                                        </td>
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $reporting = json_decode(
                                                                    @$prospecting->customer->reference->user_reporting,
                                                                );
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = coOrdinator(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
                                                                );
                                                            @endphp
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = exCoOrdinator(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = marketingInChargeEmployee(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = salesInChargeEmployee(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = areaInChargeEmployee(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $prospectingReturn = zonalManagerEmployee(
                                                                    json_decode(
                                                                        @$prospecting->customer->reference
                                                                            ->user_reporting,
                                                                    ),
