                                ...
                                <div class="card-body">
                                    <div class="table-box">
                                        ...
                                        <table id="approve_table"
                                            class="table table-hover table-bordered table-striped dt-responsive nowrap fs-10"
                                                ...
                                                @foreach ($leads as $lead)
                                                    <tr class="">
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="checkbox" name="lead_id[]"
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $dataReturn = coOrdinator($reporting);
                                                            @endphp
                                                            <center>{{ $dataReturn }}</center>
                                                        </td>
                                                        <td>
                                                            @php
                                                                ...
                                                                $dataReturn = exCoOrdinator($reporting);
                                                            @endphp
                                                            <center>{{ $dataReturn }}</center>
                                                        </td>
                                                        <td>
