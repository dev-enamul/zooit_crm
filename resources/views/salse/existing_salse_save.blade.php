                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"  class="form-control" name="unit_price" id="unit_price" value="{{isset($sales) ? $sales->regular_amount : old('regular_amount')}}" required> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"  class="form-control" name="regular_amount" id="regular_amount" value="{{isset($sales) ? $sales->regular_amount : old('regular_amount')}}" required>
                                            <div class="invalid-feedback">
                                                This field is required.
                                            </div> 
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="booking" id="booking" value="" required>
                                            <div class="invalid-feedback">
                                                This field is required.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"  class="form-control" name="down_payment_due" id="down_payment_due" value="{{ isset($selected_data['down_payment_due']) ? $selected_data['down_payment_due'] : (isset($sales) ? $sales->down_payment : old('down_payment_due')) }}">
                                        </div>
                                    </div> 

                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="rest_down_payment_date" class="form-label">Due Down payent Date <span class="text-danger">*</span></label>
                                            <input type="date"  class="form-control" name="rest_down_payment_date" id="rest_down_payment_date" value="" >  
                                        </div>
                                    </div>  

                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="total_installment_payment" class="form-label">Total Installment Payment</label>
                                            <input type="number"  class="form-control" name="total_installment_payment" id="total_installment_payment" value="" >  
                                        </div>
                                    </div>   
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#down_payment_due').on('change', function() {
                var down_payment_due = parseFloat($('#down_payment_due').val()) || 0;
                if(down_payment_due > 0){
                    $('#rest_down_payment_date').closest('.col-md-6').prop('required', true);
                    $('#rest_down_payment_date').closest('.col-md-6').show();  
                }else{
        ...
        function calculateInstallmentAmount() {
            ...
            var first_payment = parseFloat($('#total_installment_payment').val()) || 0;
