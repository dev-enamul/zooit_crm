        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                           <div class="table-box" style="overflow-x: sc roll;">
                                    ...
                                    <tbody>
                                        @foreach ($datas as $key => $data)
                                            <tr>
                                                <td class="text-center" data-bs-toggle="tooltip" title="Action">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-animated"> 
                                                            <a class="dropdown-item" href="{{route('customer.profile',encrypt($data->id))}}">Customer Profile</a>
                                                ...
                                                <td>{{get_price(@$data->project->price,@$data->project->currency)}}</td>
                                                <td>{{get_price(@$data->project->paid,@$data->project->currency)}}</td>
