                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_service">
                                    <span><i class="mdi mdi-clipboard-plus-outline"></i> Add Service</span>
                                </button>
                            </ol>
                        </div> 
                        @endcan
                                            ...
                                            <td class="text-center" data-bs-toggle="tooltip" title="Action"> 
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-animated">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="deleteItem('{{ route('service.destroy',$data->id) }}')">Delete</a>   
                                                    </div>
                                                </div> 
                                            </td> 
                                            @endcan
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header"> 
                <h5 class="modal-title">Create new Service</h5><button type="button" class="btn btn-sm btn-label-danger btn-icon" data-bs-dismiss="modal"><i class="mdi mdi-close"></i></button>
            </div>
