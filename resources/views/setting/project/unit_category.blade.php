                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Unit Category</li>
                            </ol>
                        </div> 
                    </div>
                </div>
                            ...
                            <table id=" " class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody> 
                                    <tr>
                                        ...
                                        <td>1</td>
                                        <td>A</td>  
                                        <td> contemporary features, offering a cozy and convenient lifestyle in a prime location</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>1</td>
                                        <td>B</td> 
                                        <td>premium amenities, and breathtaking views, providing the epitome of modern living</td> 
                                        <th><span class="badge badge-label-success">Active</span></th> 
                                    </tr>  
                                </tbody>
                            </table>
