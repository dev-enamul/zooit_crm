...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['slug' => 'company-type', 'name' => 'Company Type', 'status' => 1],
            ['slug' => 'company-type-manage', 'name' => 'Company Type Manage', 'status' => 1], 
            ...
            ['slug' => 'refresh-password', 'name' => "Approve Password",'status' => 1],
